...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Maio-2025 às 23:58
...
--
ALTER TABLE `anuncio`
  MODIFY `ID_Anuncio` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de tabela `aprovacao`
--
ALTER TABLE `aprovacao`
  MODIFY `ID_aprovacao` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
