...
INSERT INTO `notificacao` (`ID_Notificacao`, `Mensagem`, `DataNotificacao`, `ReferenciaID`, `UtilizadorID_User`, `ReferenciaTipoID_ReferenciaTipo`, `TIpo_notificacaoID_TipoNotificacao`, `Estado_notificacaoID_estado_notificacao`) VALUES (3,'Nova reclamação recebida para sua venda','2025-04-19 13:29:51',3,2,4,5,1);
INSERT INTO `notificacao` (`ID_Notificacao`, `Mensagem`, `DataNotificacao`, `ReferenciaID`, `UtilizadorID_User`, `ReferenciaTipoID_ReferenciaTipo`, `TIpo_notificacaoID_TipoNotificacao`, `Estado_notificacaoID_estado_notificacao`) VALUES (4,'Nova reclamação necessita de moderação','2025-04-19 13:29:51',3,1,4,5,1);
INSERT INTO `notificacao` (`ID_Notificacao`, `Mensagem`, `DataNotificacao`, `ReferenciaID`, `UtilizadorID_User`, `ReferenciaTipoID_ReferenciaTipo`, `TIpo_notificacaoID_TipoNotificacao`, `Estado_notificacaoID_estado_notificacao`) VALUES (8,'Novo pedido de registo pendente: VM','2025-04-24 20:14:41',11,1,1,1,1);
INSERT INTO `notificacao` (`ID_Notificacao`, `Mensagem`, `DataNotificacao`, `ReferenciaID`, `UtilizadorID_User`, `ReferenciaTipoID_ReferenciaTipo`, `TIpo_notificacaoID_TipoNotificacao`, `Estado_notificacaoID_estado_notificacao`) VALUES (9,'Novo pedido de registo pendente: Bug','2025-04-24 20:19:04',12,1,1,1,1);
INSERT INTO `notificacao` (`ID_Notificacao`, `Mensagem`, `DataNotificacao`, `ReferenciaID`, `UtilizadorID_User`, `ReferenciaTipoID_ReferenciaTipo`, `TIpo_notificacaoID_TipoNotificacao`, `Estado_notificacaoID_estado_notificacao`) VALUES (10,'Nova solicitação de compra para o anúncio: teste','2025-04-25 00:28:38',9,2,6,8,1);
INSERT INTO `notificacao` (`ID_Notificacao`, `Mensagem`, `DataNotificacao`, `ReferenciaID`, `UtilizadorID_User`, `ReferenciaTipoID_ReferenciaTipo`, `TIpo_notificacaoID_TipoNotificacao`, `Estado_notificacaoID_estado_notificacao`) VALUES (11,'Nova solicitação de compra para o anúncio: Movel de sala','2025-04-25 11:23:34',10,2,6,8,1);
INSERT INTO `notificacao` (`ID_Notificacao`, `Mensagem`, `DataNotificacao`, `ReferenciaID`, `UtilizadorID_User`, `ReferenciaTipoID_ReferenciaTipo`, `TIpo_notificacaoID_TipoNotificacao`, `Estado_notificacaoID_estado_notificacao`) VALUES (12,'Novo pedido de registo pendente: CR7','2025-04-26 12:42:47',13,1,1,1,1);
...
-- Dump completed on 2025-04-26 17:55:58
